...
exports.kFetchFormUrlEncoded = exports.kFetch = void 0;
var _returnFetch = _interopRequireDefault(require("return-fetch"));
var _kCreateWebError = require("./kCreateWebError");
...
const returnFetchJson = (args, formUrlEncoded = false) => {
  const fetch = (0, _returnFetch.default)(args);
  return async (url, init) => {
    ...
    if (response.status === 401) {
      throw (0, _kCreateWebError.kCreateWebError)({
        code: -401 + '',
        isAuthFailed: true,
...
const kFetch = exports.kFetch = returnFetchJson({}, false);
const kFetchFormUrlEncoded = exports.kFetchFormUrlEncoded = returnFetchJson({}, true);
